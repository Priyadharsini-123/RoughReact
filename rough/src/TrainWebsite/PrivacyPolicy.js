  ...
  <WebsiteNavbar/>
    ...
    >
      ...
      <Row className="justify-content-center ">
        <Col xs={12} md={8}>
          <h2 className="text-center mt-4 bold">Privacy Policy</h2>
        ...
        <Col xs={12} md={8} className="text-start mt-2" >
          <h5 className="bold">Personal Identification Information</h5>
        ...
        <Col xs={12} md={8} className="text-start mt-2">
          <h5 className="bold">How We Use Collected Information</h5>
          <p style={{fontSize:"20px"}}>
        ...
        <Col xs={12} md={8} className="text-start mt-2">
          <h5 className="bold">How We Protect Your Information</h5>
          <p style={{fontSize:"20px"}}>
        ...
        <Col xs={12} md={8} className="text-start mt-2">
          <h5 className="bold">Sharing Your Personal Information</h5>
          <p style={{fontSize:"20px"}}>
        ...
        <Col xs={12} md={8} className="text-start mt-2">
          <h5 className="bold">Compliance with Children Online Privacy Protection Act</h5>
          <p style={{fontSize:"20px"}} >
        ...
        <Col xs={12} md={8} className="text-start mt-2">
          <h5 className="bold">Changes to This Privacy Policy</h5>
          <p  style={{fontSize:"20px"}} >
        ...
        <Col xs={12} md={8} className="text-start mt-2 mb-3">
          <h5 className="bold">Your Acceptance of These Terms</h5>
          <p  style={{fontSize:"20px"}} >
            ...
            <a href="mailto:trainsonwheel@gmail.com">trainsonwheel@gmail.com</a>
