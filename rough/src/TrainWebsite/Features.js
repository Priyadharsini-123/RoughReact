...
import train from "../../assets/images/rail.webp"
const Features = () => {
    // const buttonStyle = {
    ...
    return (
        <div>
            <section className=' information'style={{ marginBottom: '-125px'}} >
                <img src={train} className="img-fluid shadow d-none d-md-block justify-content-center" alt="TrainsOnWheel FeatureTrainImage" title='TrainsOnWheel FeatureTrainImage'/>
            </section>
            <Container className="mt-n2 pb-5 mt-5" >
                <Row className="justify-content-center">
                    <Col md={4} className="mt-2 d-flex justify-content-center feature-col"  >
                    ...
                    <Col md={4} className="mt-2 d-flex justify-content-center feature-col">
                        <div className="bg-white shadow rounded p-4 text-center">
                            ...
                            <p style={{ fontSize: "clamp(14px, 2vw, 20px)"}} className="text-muted fontfamily">Get the latest, updated news from the directly on the Train wheels app</p>
