...
const Trainseat = () => {
  ...
  if (screenSize === 'mobile') {
    content = (
      ...
      <div className=" flex align-item-center justify-content-center gap-10 px-20 h-55  mb-3">
        <h1 className=" text-xxl font-bold text-center w-full" style={{marginTop:'80px'}}>
  ...
  />
    ...
    content = (
      <div className="tablet-content">
        <div className=" flex items-center justify-between gap-10 px-20 h-55 border-b border-solid border-charcoal-100 bg-white ">
        <h1 className="h1 text-xxl font-bold text-center ">
          Check Seat Availability
        </h1>
      </div>
      <div className="SearchBox-module_searchContainer__N6EAo SearchBox-module_true__-K8Gf">
