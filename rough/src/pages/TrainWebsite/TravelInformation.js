          ...
          <Col md={6}>
            <div className='chooseBox'>
              ...
              <div className='chooseTxt at1'>
                ...
                <p className='fonts ' style={{ fontSize: "clamp(14px, 2vw, 20px)" }}>The only official Trains on Wheels app for Indian Railways</p>
              </div>
              <div className='chooseTxt at2'>
                <h3 style={{ color: '#000', fontWeight: '700', fontSize: '25px' }}>Live Train</h3>
                <p className='fonts' style={{ fontSize: "clamp(14px, 2vw, 20px)" }}>Stay updated on your train's whereabouts with our live train status feature</p>
              </div>
              <div className='chooseTxt at3'>
                <h3 style={{ color: '#000', fontWeight: '700', fontSize: '25px' }}>Seat Availability</h3>
                <p className='fonts' style={{ fontSize: "clamp(14px, 2vw, 20px)" }}>Check IRCTC train upcoming station seat availability here</p>
              </div>
              <div className='chooseTxt at4'>
                <h3 style={{ color: '#000', fontWeight: '700', fontSize: '25px' }}>Pnr Status</h3>
                <p className='fonts'style={{ fontSize: "clamp(14px, 2vw, 20px)" }}>PNR status check to know whether train seat is confirmed or not.</p>
              </div>
              <div className='chooseTxt at5'>
                <h3 style={{ color: '#000', fontWeight: '700', fontSize: '25px' }}>Referral Amount</h3>
                <p className='fonts'style={{ fontSize: "clamp(14px, 2vw, 20px)" }}>Invite your friends to join our train app and earn referral rewards</p>
              </div>
              <div className='chooseTxt at6'>
                <h3 style={{ color: '#000', fontWeight: '700', fontSize: '25px' }}>Notification</h3>
                <p className='fonts' style={{ fontSize: "clamp(14px, 2vw, 20px)" }}>A complete solution for all your IRCTC and Metro train needs!</p>
              </div>
            </div>
          </Col>
        </Row>
