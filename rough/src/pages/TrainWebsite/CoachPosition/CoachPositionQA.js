...
import Coach from "../../../assets/images/coach positionfaq.jpg";

import Tabelt from "../../../assets/images/tabletfaq.png";
const data = {
  rows: [
    {
    ...
    {
      title:
        "Are there any apps or websites that provide real-time coach position information?",
      content:
      ...
      content: (
        <div>
          ...
          <ul>
            <li>
              {" "}
              <strong>AC First Class (1A):</strong> Luxury class with spacious
              cabins, individual berths, and curtains for privacy.
            </li>
            <li>
              {" "}
              <strong>AC 2 Tier (2A):</strong> Two-tier berths with curtains for
              privacy, suitable for long-distance travel.
            </li>
            <li>
              {" "}
              <strong>AC 3 Tier (3A):</strong> Three-tier berths with curtains
              for privacy, offering a balance between comfort and affordability.
            </li>
            <li>
              <strong>AC Chair Car (CC):</strong> Air-conditioned seating with
              adjustable seats, primarily used for day travel.
            </li>
          </ul>
          <p>Non-AC Coaches:</p>
          <ul>
            <li>
              {" "}
              <strong>Sleeper Class (SL):</strong> Non-air-conditioned berths
              with six berths per compartment, commonly used for overnight
              travel.
            </li>
            <li>
              {" "}
              <strong>General Unreserved (GS):</strong> Non-reserved seating,
              often crowded, and suitable for short-distance travel.
            </li>
            <li>
              <strong>Second Seating (2S):</strong> Non-air-conditioned seating,
              primarily used for short-distance travel.
            </li>
            <li>
              <strong>Chair Car (CC):</strong> Non-air-conditioned seating with
              adjustable seats, primarily used for day travel.
            </li>
          </ul>
        </div>
        ...
        <div>
          <div>
            <p style={{ display: "flex", justifyContent: "center" }}>
              <strong>HOW I FIND COACH POSITION ON USING DEVICE:</strong>
            </p>
          </div>
          ...
          <div>
            <strong>TABELT VIEW COACH</strong>
            <img
              src={Tabelt}
              alt="Another Image"
              style={{ maxWidth: "84%", height: "auto" }}
            />
          </div>
        </div>
      ),
    ...
    {
      title:
        "How can I access the Coach Position feature on the Trains on Wheels app?",
      content:
    ...
    {
      title:
        "How accurate is the Coach Position information provided by the app?",
      content:
