...
const HeaderAbout = () => {
 ...
 {/* who we are start */}
  ...
  backgroundColor:'rgb(242, 244, 244)'}}>
    ...
    Trains on Wheels is your go-to app for all things train-related. We're here to make your train travel experience smoother, simpler, and more enjoyable. Whether you're a frequent commuter or an occasional traveler</p>
    ...
    <p className='paragraph mb-5'style={{fontFamily:'"Poppins", sans-serif', fontSize: "clamp(18px, 5vw, 20px)",color:"black"}} mb-5>Trains on Wheels is the all-in-one official app from Indian  railway which consists of information related to  local  and metro  train ,  Express trains  & PNR status, Live Announcements from Indian Railways</p>
