...
const LiveTrain = () => {
  ...
  const [liveTrainList, setLiveTrainList] = useState("");
...
/>
  ...
  <Col xs={10} sm={10} md={10} lg={8} xl={8} className="mx-3 mb-5">
    <div style={{ fontFamily: 'Poppins, sans-serif', fontSize: '20px', lineHeight: '1.5' }}>
      <strong>Disclaimer:</strong>The platform number shown is tentative and could change. Please check at the station for the exact platform number. This train running information is not affiliated with or endorsed by indian railways or irctc.
    </div>
  </Col>
</Row>
      </Container>
